...
public class SafeHavenCommand implements CommandExecutor {
        ...
        switch (args[0].toLowerCase()) {
            case "admingui":
                if(args.length <2){
                    ...
                    handleAdminGuiCommand((Player) sender);
                }
                break;
            case "sethome":
                if (args.length < 2) {
    ...
    private void handleAdminGuiCommand(Player sender) {
